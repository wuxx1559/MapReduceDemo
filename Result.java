...
public class Result implements org.apache.thrift.TBase<Result, Result._Fields>, java.io.Serializable, Cloneable, Comparable<Result> {
  ...
  private static final org.apache.thrift.protocol.TField ELAPSED_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("elapsed_time", org.apache.thrift.protocol.TType.DOUBLE, (short)2);
  ...
  public double elapsed_time; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    FILENAME((short)1, "filename"),
    ELAPSED_TIME((short)2, "elapsed_time");
  ...
  private static final int __ELAPSED_TIME_ISSET_ID = 0;
  ...
  static {
    ...
    tmpMap.put(_Fields.ELAPSED_TIME, new org.apache.thrift.meta_data.FieldMetaData("elapsed_time", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public Result setElapsed_time(double elapsed_time) {
    this.elapsed_time = elapsed_time;
    setElapsed_timeIsSet(true);
    return this;
  }

  public void unsetElapsed_time() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ELAPSED_TIME_ISSET_ID);
  }

  /** Returns true if field elapsed_time is set (has been assigned a value) and false otherwise */
  public boolean isSetElapsed_time() {
    return EncodingUtils.testBit(__isset_bitfield, __ELAPSED_TIME_ISSET_ID);
  }

  public void setElapsed_timeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ELAPSED_TIME_ISSET_ID, value);
  }
  ...
  public boolean equals(Result that) {
    ...
    boolean this_present_elapsed_time = true;
    boolean that_present_elapsed_time = true;
    if (this_present_elapsed_time || that_present_elapsed_time) {
      if (!(this_present_elapsed_time && that_present_elapsed_time))
        return false;
      if (this.elapsed_time != that.elapsed_time)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_elapsed_time = true;
    list.add(present_elapsed_time);
    if (present_elapsed_time)
  ...
  public int compareTo(Result other) {
    ...
    lastComparison = Boolean.valueOf(isSetElapsed_time()).compareTo(other.isSetElapsed_time());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetElapsed_time()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.elapsed_time, other.elapsed_time);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class ResultStandardScheme extends StandardScheme<Result> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // ELAPSED_TIME
            if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
              struct.elapsed_time = iprot.readDouble();
              struct.setElapsed_timeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Result struct) throws org.apache.thrift.TException {
      ...
      oprot.writeDouble(struct.elapsed_time);
      oprot.writeFieldEnd();
